...
export const aspectData = [
  ...
  },
  {
    ...
    represent: 'A4',
    description: 'Understanding the boundaries and relationships between human intelligence and artificial intelligence.',
  },
  {
...
export function findAspectByName(aspectName) {
  return aspectData.find(aspect => 
    aspect.name.toLowerCase() === aspectName.toLowerCase()
  ) || null;
}
